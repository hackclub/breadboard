...
import "@/components/velxio/components/velxio-components/PiPicoWElement"; // registers velxio-pi-pico-w
import "@/components/velxio/components/velxio-components/Stm32BluePillElement"; // registers velxio-stm32-bluepill
...
const BOARD_DESCRIPTIONS: Partial<Record<BoardKind, string>> = {
  ...
  "stm32-f4-discovery":
    "STM32F407VG Cortex-M4, 1MB flash, 4 onboard LEDs (QEMU)",
        ...
        {showIgnoreStockWarning ? (
          <div className="plain-warning-backdrop">
            ...
            >
              ...
              <p>
                It also shows extra parts beyond your kit, so you can source
                your own.
              </p>
...
const ComponentCard: React.FC<ComponentCardProps> = ({
  ...
  React.useEffect(() => {
    ...
    let scale = 0.5;
    if (
      component.tagName.includes("arduino") ||
      component.tagName.includes("esp32")
    ) {
      scale = 0.35; // Boards are larger, scale them down more
    } else if (
      component.tagName.includes("lcd") ||
      component.tagName.includes("display")
    ) {
    ...
    if (component.tagName === "wokwi-led") {
      ...
      component.tagName === "wokwi-lcd1602" ||

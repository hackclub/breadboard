...
import { Voltmeter } from "@/components/velxio/components/components-instruments/Voltmeter";
import { Ammeter } from "@/components/velxio/components/components-instruments/Ammeter";

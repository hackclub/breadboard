...
import "@/components/velxio/components/editor/FileTabs.css";
  ...
  return (
    <>
      <div className="file-tabs">
        {ownerLabel && (
          <span
            className="file-tabs-owner"
            title={`These files belong to ${ownerLabel}`}
          >
            {ownerLabel}
          </span>
        )}
          ...
          >
            {file.modified && (
              <span
                ...
                title={t("editor.fileTabs.unsavedChanges")}
              />
            )}

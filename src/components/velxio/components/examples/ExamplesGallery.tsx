...
import {
  exampleProjects,
  type ExampleProject,
} from "@/lib/velxio/data/examples";
import { ExampleThumbnail } from "@/components/velxio/components/examples/ExampleThumbnail";
import "@/components/velxio/components/examples/ExamplesGallery.css";
...
export const ExamplesGallery: React.FC<ExamplesGalleryProps> = ({
  ...
  const handleCopyLink = useCallback(
    (e: React.MouseEvent, exampleId: string) => {
  ...
  const filteredExamples = exampleProjects
    .filter((example) => {
      const boardMatch =
        ...
        (selectedBoard === "retro"
          ? isRetro(example)
          : getBoardFilter(example) === selectedBoard);
      const catMatch =
        ...
        <div className="filter-group">
          ...
          <div className="filter-buttons">
            {(
              ...
              >
                {cat !== "all" &&
                  getCategoryIcon(cat as ExampleProject["category"])}{" "}

...
import type {
  ...
  ESP32CoreSelect,
  SpiffsFile,
} from "@/lib/velxio/types/boardOptions";
import {
  CORE_SELECT_OPTIONS,
  CPU_FREQ_OPTIONS,
  DEBUG_LEVEL_OPTIONS,
...
import "@/components/velxio/components/simulator/BoardOptionsModal.css";
...
export const BoardOptionsModal = ({
  ...
  const update = useCallback(
    (patch: Partial<ESP32BoardOptions>) =>
      setDraft((d) => ({ ...d, ...patch })),
    [],
  );
                ...
                <div className="bom-row">
                  ...
                  <div className="bom-control">
                    <select
                      ...
                      onChange={(e) =>
                        update({
                          partitionScheme: e.target
                            .value as ESP32BoardOptions["partitionScheme"],
                        })
                      }
                    >
                  ...
                  <div className="bom-control">
                    <select
                      ...
                      onChange={(e) =>
                        update({
                          flashSize: e.target
                            .value as ESP32BoardOptions["flashSize"],
                        })
                      }
                    >
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        update({
                          cpuFreqMHz: Number(
                            e.target.value,
                          ) as ESP32BoardOptions["cpuFreqMHz"],
                        })
                      }
                    >
                ...
                <div className="bom-row">
                  ...
                  <div className="bom-control">
                    <select
                      ...
                      onChange={(e) =>
                        update({
                          flashFreqMHz: e.target
                            .value as ESP32BoardOptions["flashFreqMHz"],
                        })
                      }
                    >
                  ...
                  <div className="bom-control">
                    <select
                      ...
                      onChange={(e) =>
                        update({
                          flashMode: e.target
                            .value as ESP32BoardOptions["flashMode"],
                        })
                      }
                    >
                  ...
                  <div className="bom-row">
                    ...
                    <div className="bom-control">
                      <select
                        ...
                        onChange={(e) =>
                          update({
                            psram: e.target.value as ESP32BoardOptions["psram"],
                          })
                        }
                      >
                ...
                <div className="bom-row">
                  ...
                  <div className="bom-control">
                    <input
                      ...
                      onChange={(e) =>
                        update({ eraseFlashOnUpload: e.target.checked })
                      }
                    />

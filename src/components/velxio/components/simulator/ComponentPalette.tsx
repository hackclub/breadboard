// @ts-nocheck
import "@/components/velxio/components/simulator/ComponentPalette.css";
import type { ComponentTemplate } from "@/lib/velxio/types/components";
...
export const ComponentPalette = ({ onDragStart }: ComponentPaletteProps) => {
  const handleDragStart =
    (template: ComponentTemplate) => (e: React.DragEvent) => {

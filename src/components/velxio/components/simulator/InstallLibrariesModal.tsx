...
import { installLibrary } from "@/services/velxio/services/libraryService";
import "@/components/velxio/components/simulator/InstallLibrariesModal.css";
      ...
      <div className="ilib-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="ilib-subtitle">
          {running ? (
            ...
            <span className="ilib-subtitle-done">
        ...
        <div className="ilib-list">
          {items.map((item) => {
            ...
            return (
              <div
                key={item.spec}
                className={`ilib-item ilib-item--${item.status}`}
              >
                ...
                <span className="ilib-item-status">
                  ...
                  {item.status === "error" && (
                    <span
                      className="ilib-badge ilib-badge--error"
                      title={item.error}
                    >
                      <svg
                        width="12"

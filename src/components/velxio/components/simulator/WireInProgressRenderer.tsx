...
import type { WireInProgress } from "@/lib/velxio/types/wire";
import { generatePreviewPath } from "@/lib/velxio/utils/wireUtils";
...
export const WireInProgressRenderer: React.FC<Props> = ({ wireInProgress }) => {
  const { startEndpoint, waypoints, color, currentX, currentY } =
    wireInProgress;

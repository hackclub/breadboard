...
const PIN_INFO: ReadonlyArray<{
  ...
  { name: "VCC", x: PIN_X[0], y: TOP_Y, description: "VCC (Pin 8)" },
  {
    ...
    x: PIN_X[1],
    y: TOP_Y,
    description: "PB2 / SCK / SCL / ADC1 (Pin 7)",
  },
  {
    name: "PB1",
    x: PIN_X[2],
    y: TOP_Y,
    description: "PB1 / MISO / OC0B / OC1A (Pin 6)",
  },
  {
    name: "PB0",
    x: PIN_X[3],
    y: TOP_Y,
    description: "PB0 / MOSI / SDA / OC0A (Pin 5)",
  },
  ...
  { name: "PB5", x: PIN_X[0], y: BOT_Y, description: "PB5 / RESET (Pin 1)" },
  {
    ...
    x: PIN_X[1],
    y: BOT_Y,
    description: "PB3 / XTAL1 / ADC3 (Pin 2)",
  },
  {
    name: "PB4",
    x: PIN_X[2],
    y: BOT_Y,
    description: "PB4 / XTAL2 / ADC2 (Pin 3)",
  },

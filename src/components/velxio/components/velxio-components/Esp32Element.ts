...
export const ESP32_ADC_PIN_MAP: Record<
  number,
  { adc: 1 | 2; ch: number; chn: number }
> = {
  36: { adc: 1, ch: 0, chn: 0 },
  37: { adc: 1, ch: 1, chn: 1 },
  38: { adc: 1, ch: 2, chn: 2 },
...
const BOARD_CONFIGS: Record<string, BoardConfig> = {
  ...
  "wemos-lolin32-lite": {
    svgUrl: wemosLolin32SvgUrl,
    w: 128,
    h: 250,
    pins: PINS_WEMOS_LOLIN32,
  },
  "xiao-esp32-s3": {
    svgUrl: xiaoEsp32S3SvgUrl,
    w: 91,
    h: 117,
    pins: PINS_XIAO_ESP32_S3,
  },
  "arduino-nano-esp32": {
  ...
  "xiao-esp32-c3": {
    svgUrl: xiaoEsp32C3SvgUrl,
    w: 91,
    h: 117,
    pins: PINS_XIAO_ESP32_C3,
  },

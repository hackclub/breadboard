...
if (!customElements.get("velxio-logic-or"))
  customElements.define("velxio-logic-or", OrGateElement);
...
function makeMultiInputGateClass(
  variant: "and" | "or" | "nand" | "nor",
  inputs: number,
) {
  ...
  return class extends HTMLElement {
    ...
    constructor() {
      super();
      this.attachShadow({ mode: "open" }).innerHTML = makeMultiInputGateSvg(
        variant,
        inputs,
        text,
      );
...
if (!customElements.get("velxio-logic-or-3"))
  customElements.define("velxio-logic-or-3", Or3Gate);
...
if (!customElements.get("velxio-logic-or-4"))
  customElements.define("velxio-logic-or-4", Or4Gate);

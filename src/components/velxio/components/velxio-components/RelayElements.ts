...
if (!customElements.get("velxio-relay"))
  customElements.define("velxio-relay", RelayElement);
...
if (!customElements.get("velxio-opto-4n25"))
  customElements.define("velxio-opto-4n25", Opto4N25);
if (!customElements.get("velxio-opto-pc817"))
  customElements.define("velxio-opto-pc817", OptoPC817);

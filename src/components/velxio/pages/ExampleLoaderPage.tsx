...
import { exampleProjects } from "@/lib/velxio/data/examples";
import {
  loadExample,
  type LibraryInstallProgress,
} from "@/lib/velxio/utils/loadExample";
...
export const ExampleLoaderPage: React.FC = () => {
  ...
  const [installing, setInstalling] = useState<LibraryInstallProgress | null>(
    null,
  );

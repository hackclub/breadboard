...
function _switchInput(
  ...
  return {
    components: [
      sw(switchId, x, y, initial),
      res(resId, x + 90, y + 30, "10000"),
    ],
    wires: [
...
export const digitalExamples: ExampleProject[] = [
  ...
  (() => {
    ...
    for (let i = 0; i < N; i++) {
      ...
      const cinSrc: [string, string] =
        i === 0 ? ["sCin", "2"] : [`orC_${i - 1}`, "Y"];
      wires.push(

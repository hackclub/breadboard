...
export const IGNORE_STOCK_ONLY_COMPONENTS: ReadonlySet<string> = new Set([
  ...
  "resistor-330", "resistor-470", "resistor-2k2", "resistor-4k7",
  "resistor-22k", "resistor-47k", "resistor-100k", "resistor-1m",
  "capacitor", "capacitor-electrolytic", "inductor",
  "cap-10p", "cap-22p", "cap-100p", "cap-1n", "cap-10n", "cap-100n", "cap-1u",
  "cap-elec-1u", "cap-elec-10u", "cap-elec-47u", "cap-elec-100u",
  "cap-elec-470u", "cap-elec-1000u",
  "ind-100u", "ind-1m", "ind-10m",
  // Diodes
  "diode", "diode-1n4148", "diode-1n4007", "diode-1n5817", "diode-1n5819",
  "zener-1n4733", "photodiode",
  // Transistors
  "bjt-2n2222", "bjt-bc547", "bjt-2n3055", "bjt-2n3906", "bjt-bc557",
  "mosfet-2n7000", "mosfet-irf540", "mosfet-irf9540", "mosfet-fqp27p06",
  // Op-amps
  "opamp-ideal", "opamp-lm358", "opamp-lm741", "opamp-tl072", "opamp-lm324",
  // Regulators + power sources
  "reg-7805", "reg-7812", "reg-7905", "reg-lm317",
  "battery-9v", "battery-aa", "battery-coin-cell",
  "power-supply", "signal-generator",
  // Optocouplers
  "opto-4n25", "opto-pc817",
  // Logic gates (2/3/4-input families)
  "logic-gate-and", "logic-gate-nand", "logic-gate-or", "logic-gate-nor",
  "logic-gate-xor", "logic-gate-xnor", "logic-gate-not",
  "logic-gate-and-3", "logic-gate-or-3", "logic-gate-nand-3", "logic-gate-nor-3",
  "logic-gate-and-4", "logic-gate-or-4", "logic-gate-nand-4", "logic-gate-nor-4",
  // 74HC logic ICs
  "ic-74hc00", "ic-74hc02", "ic-74hc04", "ic-74hc08", "ic-74hc14",
  "ic-74hc32", "ic-74hc86",
  // Motor drivers
  "motor-driver-l293d", "a4988",
  // Sensors
  "hc-sr04", "dht22", "mpu6050", "ds1307", "ky-040", "hx711", "gas-sensor",
  "flame-sensor", "big-sound-sensor", "small-sound-sensor", "heart-beat-sensor",
  "ntc-temperature-sensor", "microsd-card", "tilt-switch", "bmp280",
  // Displays / LED strips
  "ssd1306", "ssd1306-spi", "lcd2004", "lcd2004-i2c", "ili9341",
  "neopixel", "neopixel-matrix", "led-ring", "led-bar-graph",
  "epaper-1in54-bw", "epaper-2in13-bw", "epaper-2in13-bwr", "epaper-2in9-bw",
  "epaper-2in9-bwr", "epaper-4in2-bw", "epaper-7in5-bw", "epaper-5in65-7c",
  // Input / switches
  "slide-switch", "dip-switch-8", "pushbutton-6mm", "slide-potentiometer",
  "rotary-dialer", "biaxial-stepper",
  // Bench instruments + custom chip (injected in ComponentRegistry, no kit)
  "custom-chip", "instr-voltmeter", "instr-ammeter",
]);
...
// Everything the picker may show while ignore stock is on: both kits' parts
// plus the ignore-stock-only extras.
...
// Everything the registry should load: kit parts plus the ignore-stock-only
// extras. Non-kit parts that aren't in the ignore-stock bucket (e.g. bare
// boards) are still dropped so they don't leak into the component grid.
export function filterAvailableComponents(
  components: ComponentMetadata[],
): ComponentMetadata[] {
  return components.filter((component) => isIgnoreStockComponent(component.id));
}

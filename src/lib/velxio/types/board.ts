...
export interface BoardInstance {
  ...
  boardOptions?: import("@/lib/velxio/types/boardOptions").ESP32BoardOptions;
  spiffsFiles?: import("@/lib/velxio/types/boardOptions").SpiffsFile[];
}
...
export function boardDisplayName(
  board: Pick<BoardInstance, "name" | "boardKind">,
): string {
...
export const BOARD_KIND_FQBN: Record<BoardKind, string | null> = {
  ...
  "stm32-blackpill-f401":
    "STMicroelectronics:stm32:GenF4:pnum=BLACKPILL_F401CE",
  ...
  "stm32-netduino-plus2":
    "STMicroelectronics:stm32:GenF4:pnum=GENERIC_F405RGTX",

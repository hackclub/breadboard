...
export function useSEO({
  ...
  useEffect(() => {
    ...
    const get = (el: HTMLMetaElement | null) =>
      el?.getAttribute("content") ?? "";
    const set = (el: HTMLMetaElement | null, v: string) =>
    ...
    let activeCanonical: HTMLLinkElement | null =
      canonicalEl as HTMLLinkElement | null;
    if (!activeCanonical) {
